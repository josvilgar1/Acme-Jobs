...
<acme:list>
	...
	<acme:list-column code="administrator.announcement.list.label.url" path="url" width="20%"/>
	<acme:list-column code="administrator.announcement.list.label.text" path="text" width="50%"/>		
</acme:list>
