...
<acme:list >
	...
	<acme:list-column code="authenticated.offer.list.label.rangeMin" path="rangeMin" width="10%"/>		
	<acme:list-column code="authenticated.offer.list.label.rangeMax" path="rangeMax" width="10%"/>		
</acme:list>
