...
<acme:list >
	...
	<acme:list-column code="anonymous.companyrecord.list.label.description" path="description" width="20%"/>		
	<acme:list-column code="anonymous.companyrecord.list.label.web" path="web" width="10%"/>		
